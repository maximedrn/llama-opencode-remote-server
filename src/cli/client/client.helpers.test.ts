...
import {
  ...
  servedModels,
  smokeTest,
} from "@app/cli/client/client.helpers.ts";
import type { ClientDependencies } from "@app/cli/client/client.interface.ts";
import {
  LlamaAuthError,
...
const run = <A, E>(
  baseUrl: string,
  use: (dependencies: ClientDependencies) => Effect.Effect<A, E>,
...
const completion: { readonly choices: readonly unknown[] } = {
